...
const storyText = '気温 華氏40度で外は寒かった。:insertx: は出かけた。:inserty: についた。:insertz:。 体重110ポンドの :insertx: は驚いたが、　ゆかは驚かなかった。　:inserty:　ではよくあることだった。';
...
function result() {
  ...
  if (customName.value !== '') {
    ...
    newStory = newStory.replace('ゆか', name);
  }
